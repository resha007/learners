...
<head>
    ...
    <title>Driving License Type</title>
...
<body onload="dataLoad()">
                    ...
                    <strong class="headings"></strong>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Driving License Type</strong>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Existing Driving License Types</strong><br>
	...
	<script type="text/javascript" src="<?=base_url()?>assets/js/custom/dlTypeJS.js"></script>
