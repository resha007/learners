...
<body onload="dataLoad()">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <strong class="headings"></strong>
                            ...
                            <div class="card-body card-block">
                                <form action="#" method="post" class="form-horizontal" id="dataForm">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Code<span class="req"> *</span></label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="txtCode" name="txtCode" placeholder="Enter code" class="form-control"></div>
                                    </div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Name<span class="req"> *</span></label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="txtName" name="txtName" placeholder="Enter name" class="form-control"></div>
                                    </div>
									<div class="row form-group">
                                        <div class="col col-md-3"><label class=" form-control-label">Description<span class="req"> *</span></label></div>
                                        <div class="col-12 col-md-9"><textarea id="txtDesc" name="txtDesc" placeholder="Enter description" class="form-control" style="resize:none"></textarea></div>
                                    </div>
									<div class="row form-group">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Existing Users</strong><br>
	...
	<script type="text/javascript" src="<?=base_url()?>assets/js/custom/userJS.js"></script>
